...
class MyAsyncConsumer(AsyncConsumer):
    ...
    async def websocket_receive(self, event):
        ...
        # finding group from DB and in async you also have to database_sync_to_async all ORM queries
        ...
        # in async you also have to database_sync_to_async all ORM queries
